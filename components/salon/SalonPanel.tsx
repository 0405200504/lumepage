          ...
          <div className="relative card w-full sm:max-w-md mx-0 sm:mx-4 rounded-b-none sm:rounded-4xl p-6 z-10 animate-slide-up">
            ...
            {createdPass ? (
              ...
              <form onSubmit={addFuncionaria} className="space-y-3">
                <input required value={fName} onChange={(e) => setFName(e.target.value)} placeholder="Nome completo" className="w-full px-3 py-3 bg-n-50 border border-n-200 rounded-xl text-label focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wine-700" />
                <input required value={fBrand} onChange={(e) => setFBrand(e.target.value)} placeholder="Nome da marca / espaço" className="w-full px-3 py-3 bg-n-50 border border-n-200 rounded-xl text-label focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wine-700" />
                <input required type="email" value={fEmail} onChange={(e) => setFEmail(e.target.value)} placeholder="E-mail de login" className="w-full px-3 py-3 bg-n-50 border border-n-200 rounded-xl text-label focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wine-700" />
                <input required inputMode="tel" value={fPhone} onChange={(e) => setFPhone(e.target.value)} placeholder="WhatsApp (com DDD)" className="w-full px-3 py-3 bg-n-50 border border-n-200 rounded-xl text-label focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wine-700" />
