    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 h-14 w-14 bg-wine-700 text-white rounded-full shadow-glow flex items-center justify-center hover:scale-105 transition-transform z-50 tap"
