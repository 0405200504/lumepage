...
const inputClass =
  'block w-full pl-10 pr-3 py-3 bg-cream/60 border border-gray-150 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-wine-700/15 focus:border-wine-700 transition-all';
      ...
      <div className="card-elevated glow-wine p-7 md:p-9">
        {step === 1 ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-[10px] font-bold text-gray-450 uppercase tracking-wider mb-2">Nome do seu negócio</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
              ...
              <p className="text-[11px] text-gray-500 mt-1.5">É o nome que suas clientes veem na página de agendamento.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 mt-1.5">Usado nas confirmações e lembretes das clientes.</p>
            </div>

            <div>
              <label className="block text-[10px] font-bold text-gray-450 uppercase tracking-wider mb-2">Endereço da sua página</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <Link2 className="h-4 w-4 text-gray-450" />
                </div>
                <input
                  type="text"
                  required
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-3 p-4 bg-cream/60 border border-gray-150 rounded-2xl">
              <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-wine-700 text-white">
                <Check className="h-4 w-4" />
              </span>
              <div>
                <p className="text-sm font-bold text-gray-800">Sua página está no ar</p>
            ...
            {googleConnected ? (
              ...
              <button
                ...
                className="tap flex items-center justify-center gap-2 w-full py-3.5 bg-white border border-gray-200 text-gray-700 text-sm font-bold rounded-2xl hover:bg-gray-50 transition-all-custom"
              >
                <CalendarCheck className="h-4 w-4 text-wine-700" />
            ...
            <button
              ...
              className="tap flex items-center justify-center gap-2 w-full py-4 surface-wine hover:opacity-95 text-white text-sm font-bold rounded-2xl shadow-soft transition-all-custom cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={() => setStep(1)}
              className="w-full text-[11px] font-bold text-gray-450 hover:text-gray-700 transition-colors"
            >
              Corrigir meus dados
            </button>
          </div>
