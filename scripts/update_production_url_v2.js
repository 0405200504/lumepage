...
if (fs.existsSync(layout1)) {
  ...
  content = content.replace(/https:\/\/lume\.vercel\.app/g, 'https://lume-agendamentos.vercel.app');
...
for (const dir of dirs) {
  ...
  execSync('git add . && git commit -m "Corrigir url de producao do widget para lume-agendamentos.vercel.app" && git push', { cwd: repoPath, stdio: 'inherit' });
}
