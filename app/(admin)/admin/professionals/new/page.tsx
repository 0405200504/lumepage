...
import { ArrowLeft, Check, Sparkles, AlertCircle, Copy, CheckCircle2 } from 'lucide-react';
...
export default function NewProfessionalPage() {
  ...
  // Mock Session para Client Components (na renderização real usaremos a props passada por um Server Component pai,
  // mas para simplificar a rota direta do Next.js sem quebras de layout, criamos uma sessão simulada para renderização básica se necessário)
  const mockSession = {
    profile_id: 'admin_id',
    auth_user_id: null,
    name: 'Admin Lume',
