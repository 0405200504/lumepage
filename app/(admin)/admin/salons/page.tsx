...
export const metadata = { title: 'Salões | Lume Admin' };
...
export default async function AdminSalonsPage() {
  ...
  return (
    <LayoutAdmin session={session} title="Salões" subtitle="Crie salões, vincule profissionais e gere o acesso do gerente (1 login para todos os painéis).">
      <AdminSalons
        salons={salons}
